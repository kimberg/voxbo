...
public:
  ...
  int SincResampleCube(const Cube &mycube,Cube &newcube);   // do it for each cube
...
// image manipulations
void enlarge(Cube &cb,uint32 radius,uint32 xradius,uint32 yradius,uint32 zradius);
