...
// set env dir
void DBserver::setEnvHome(const string& inputStr) { dbs.dirname = inputStr; }

// get env dir
string DBserver::getEnvHome() { return dbs.dirname; }

// Defined for some utility functions that need env to build transaction handle
DbEnv& DBserver::getEnv() { return dbs.env.getEnv(); }

// Get error message (may be used for log file)
string DBserver::getErrMsg() { return errMsg; }
