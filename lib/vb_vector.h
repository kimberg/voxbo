...
class VB_Vector {
 private:
   ...
   *********************************************************************/
  static void makePhi(double* phi, const int length,
                      const double timeShift);  // QQ tested
 public:
   ...
   *********************************************************************/
  inline bool getState() { return this->valid; }  // inline bool getState()
   ...
   *********************************************************************/
  static double euclideanProduct(const gsl_vector* V1,
                                 const gsl_vector* V2);  // QQ tested
  static double euclideanProduct(const gsl_vector& V1,
                                 const gsl_vector& V2);  // QQ tested
  ...
  friend VB_Vector operator*(const double alpha,
                             const VB_Vector& V);  // QQ tested
   ...
   *********************************************************************/
  friend bool operator==(const gsl_vector* V1,
                         const VB_Vector& V2);  // QQ tested
  friend bool operator==(const gsl_vector& V1,
                         const VB_Vector& V2);  // QQ tested
   ...
   * the MATLAB style convolution function.                             *
   *********************************************************************/
  static VB_Vector convolve(const VB_Vector* v1,
                            const VB_Vector* v2);  // QQ tested
  static VB_Vector convolve(const VB_Vector& v1,
                            const VB_Vector& v2);  // QQ tested
  static VB_Vector convolve(const gsl_vector* v1,
                            const gsl_vector* v2);  // QQ tested
  static VB_Vector convolve(const gsl_vector& v1,
                            const gsl_vector& v2);  // QQ tested
   ...
   *********************************************************************/
  static VB_Vector concatenate(const VB_Vector& V1,
                               const VB_Vector& V2);  // QQ tested
  static VB_Vector concatenate(const VB_Vector* V1,
                               const VB_Vector* V2);  // QQ tested
  static VB_Vector concatenate(const gsl_vector& V1,
                               const gsl_vector& V2);  // QQ tested
  static VB_Vector concatenate(const gsl_vector* V1,
                               const gsl_vector* V2);  // QQ tested
  ...
  VB_Vector orthogonalize(const VB_Vector& myVec,
   ...
   * Phase shift methods.                                               *
   *********************************************************************/
  static void phaseShift(const VB_Vector& tSeries, const double timeShift,
                         VB_Vector& shiftedSignal);  // QQ tested
  void phaseShift(const double timeShift,
                  VB_Vector& shiftedSignal) const;  // QQ tested
  ...
  void sort() {
    if (theVector) gsl_sort_vector(theVector);
  }
};  // class VB_Vector
