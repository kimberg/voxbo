...
struct nifti_1_header { /* NIFTI-1 usage         */ /* ANALYZE 7.5 field(s) */
  ...
  int32 sizeof_hdr; /*!< MUST be 348           */    /* int sizeof_hdr;      */
  char data_type[10]; /*!< ++UNUSED++            */  /* char data_type[10];  */
  char db_name[18]; /*!< ++UNUSED++            */    /* char db_name[18];    */
  int32 extents; /*!< ++UNUSED++            */       /* int extents;         */
  int16 session_error; /*!< ++UNUSED++            */ /* short session_error; */
  char regular; /*!< ++UNUSED++            */        /* char regular;        */
  char dim_info; /*!< MRI slice ordering.   */       /* char hkey_un0;       */

  /*--- was image_dimension substruct ---*/
  int16 dim[8]; /*!< Data array dimensions.*/      /* short dim[8];        */
  ...
  float intent_p3; /*!< 3rd intent parameter. */   /* short unused12;      */
                                                   /* short unused13;      */
  int16 intent_code; /*!< NIFTI_INTENT_* code.  */ /* short unused14;      */
  int16 datatype; /*!< Defines data type!    */    /* short datatype;      */
  int16 bitpix; /*!< Number bits/voxel.    */      /* short bitpix;        */
  int16 slice_start; /*!< First slice index.    */ /* short dim_un0;       */
  float pixdim[8]; /*!< Grid spacings.        */   /* float pixdim[8];     */
  float vox_offset; /*!< Offset into .nii file */  /* float vox_offset;    */
  float scl_slope; /*!< Data scaling: slope.  */   /* float funused1;      */
  float scl_inter; /*!< Data scaling: offset. */   /* float funused2;      */
  int16 slice_end; /*!< Last slice index.     */   /* float funused3;      */
  ...
  int32 glmax; /*!< ++UNUSED++            */          /* int glmax;           */
  int32 glmin; /*!< ++UNUSED++            */          /* int glmin;           */

  /*--- was data_history substruct ---*/
  char descrip[80]; /*!< any text you like.    */  /* char descrip[80];    */
  char aux_file[24]; /*!< auxiliary filename.   */ /* char aux_file[24];   */

  int16 qform_code; /*!< NIFTI_XFORM_* code.   */ /*-- all ANALYZE 7.5 ---*/
  int16 sform_code; /*!< NIFTI_XFORM_* code.   */ /*   fields below here  */
                                                  /*   are replaced       */
