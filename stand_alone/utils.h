 ...
 * MAT1 files.                                                        *
 *********************************************************************/
short refOrTextOrMat(const string& vbFile, bool printErr = false);
 ...
 *********************************************************************/
template <class T>
unsigned short getBit(const T& theObj, const unsigned short bitNum) {
  /*********************************************************************
  ...
  if (bitNum >= (sizeof(theObj) * 8)) {
    ...
    errorMsg << "The specfied bit number [" << bitNum
             << "] is greater than the number of available bits ["
             << sizeof(theObj) << "].";
...
}  // template<class T> unsigned short getBit(const T& theObj, const unsigned
   // short bitNum)
