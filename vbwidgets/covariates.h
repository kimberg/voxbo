...
class Contrast : QObject {
 ...
 public:
  Contrast(std::vector<Covariate>& aCovList, QObject* parent = 0,
           const char* name = 0);
...
class CovariatesView : public Q3ListView {
 ...
 public:
  ...
  virtual void buildTree(std::vector<Covariate>& aCovList,
                         bool aShowAll = true);
  ...
  Q3ListViewItem* findChild(const Q3ListViewItem* parent, const QString& text,
                            int column) const;
